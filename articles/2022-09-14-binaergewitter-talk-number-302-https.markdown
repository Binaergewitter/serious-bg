---
layout: post
title: "Binärgewitter Talk #302: irgendwas mit https"
date: 2022-09-14 23:00:00

comments: true
categories: talk
sharing: true
published: true
chapters: https://download.binaergewitter.de/2022-09-13.Binaergewitter.Talk.302.chapters.txt
audioformats:
  mp3: https://download.binaergewitter.de/2022-09-13.Binaergewitter.Talk.302.mp3
  ogg: https://download.binaergewitter.de/2022-09-13.Binaergewitter.Talk.302.ogg
  m4a: https://download.binaergewitter.de/2022-09-13.Binaergewitter.Talk.302.m4a
  opus: https://download.binaergewitter.de/2022-09-13.Binaergewitter.Talk.302.opus
---
## Blast from the Past
- fly.io - RAM Probleme und Erklärung dass das VMs sind firecracker
...
- [Ubuntu Unity]( https://www.linux-magazin.de/news/ubuntu-unity-wird-offizielle-variante/ )
...
## News
- [Gematik braucht doch keinen Hardware-Wechsel]( https://www.heise.de/news/Gematik-lenkt-bei-Hardware-Tausch-ein-E-Rezept-auf-Gesundheitskarte-frueher-7248124.html )
- [Patreon confirms security team layoffs]( https://techcrunch.com/2022/09/09/patreon-security-layoffs/ )
- [borgbackup 2.0.0b2 - beta quality, for testing only]( https://github.com/borgbackup/borg/releases/tag/2.0.0b2 )
- [LLVM 15.0.0]( https://discourse.llvm.org/t/llvm-15-0-0-release/65099 )
- [Experimental Networking Support for FreeBSD Jails with runj]( https://samuel.karp.dev/blog/2022/09/experimental-networking-support-for-freebsd-jails-with-runj/ )
- [MagicLinks]( https://digitalservice.bund.de/blog/magic-links-sicher-und-passwortlos )
...
- [neue RadioTux Sendung](https://www.radiotux.de/index.php?/archives/8083-RadioTux-Sendung-AugustSeptember-2022.html )
