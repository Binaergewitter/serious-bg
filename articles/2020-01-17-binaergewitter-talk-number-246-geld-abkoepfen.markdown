...
- [SafeGuard MailGateway](http://www.utimaco.com )
 * [Enigmail MDCk]( https://sourceforge.net/p/enigmail/forum/support/thread/03ebee57/ )
- [SHA-1 real-world attack]( https://arstechnica.com/information-technology/2020/01/pgp-keys-software-security-and-much-more-threatened-by-new-sha1-exploit/ )
- [SHA-1 is a Shambles](https://eprint.iacr.org/2020/014.pdf )
 * [DNS / DNSSec Implikationen](https://www.dns.cam.ac.uk/news/2020-01-09-sha-mbles.html )


## Blast
- [Port calibre to python3]( https://github.com/kovidgoyal/calibre/pull/870 )
- [RedHat Support]( https://access.redhat.com/support/policy/updates/errata )

## Toter der Woche
- [Einheitliche Handy Ladegeräte]( https://www.heise.de/newsticker/meldung/Einheitliche-Handy-Ladegeraete-Die-EU-kommt-nicht-in-die-Struempfe-4637443.html )
- [User Agent Strings]( https://www.zdnet.com/article/google-to-phase-out-user-agent-strings-in-chrome/ )
- [NSA meldet Lücken statt sie auszunutzen](https://www.heise.de/security/meldung/NSA-meldet-Windows-Luecke-anstatt-sie-auszunutzen-4637752.html )
- [Windows 10 Crypto kaputt]( https://www.wired.com/story/nsa-windows-10-vulnerability-disclosure/ )
- [Windows 7]( https://www.theregister.co.uk/2020/01/14/windows_7_hysteria/ )
 * [Umstieg zu Plasma](https://peertube.mastodon.host/videos/watch/230457b7-ebd2-4058-a23b-24d08201a9e3 )

## Untoter der Woche
- [reiser5]( https://www.pro-linux.de/news/1/27699/dateisystem-reiser5-soll-skalierbarkeit-und-effizienz-steigern.html )

## News

- [/dev/random blockt nicht mehr (meistens)]( https://news.ycombinator.com/item?id=21978472 )
...
## Lesefoo
- [Bash $* and $@]( https://eklitzke.org/bash-$%2A-and-$@ )
