...
sharing: true
published: true
chapters: https://download.binaergewitter.de/2023-03-05.Binaergewitter.Talk.333.chapters.txt
audioformats:
  mp3: https://download.binaergewitter.de/2023-03-05.Binaergewitter.Talk.333.mp3
  ogg: https://download.binaergewitter.de/2023-03-05.Binaergewitter.Talk.333.ogg
  m4a: https://download.binaergewitter.de/2023-03-05.Binaergewitter.Talk.333.m4a
  opus: https://download.binaergewitter.de/2023-03-05.Binaergewitter.Talk.333.opus
voices:
  l33tname: true
  madmas: false
  ingo: true
...
## Blast from the Past
- [Laptop mit Floppy-Laufwerk]( https://blog.binaergewitter.de/2024/02/17/binaergewitter-talk-number-332-divgartencenter#isso-2400 )
 - [USB Diskettenlaufwerk]( https://amzn.to/43aTGLs )
- [Echo Connect: wurde viel als Notruftool genutzt]( https://blog.binaergewitter.de/2024/02/17/binaergewitter-talk-number-332-divgartencenter#isso-2401 )

## Toter der Woche
- [DB Streckenagent]( https://www.heise.de/news/DB-Streckenagent-soll-im-DB-Navigator-aufgehen-9646477.html )

## Untoter der Woche
- [Altera]( https://www.heise.de/news/Intel-gruendet-Altera-neu-9642997.html )
...
- [ArtPrompt]( https://arxiv.org/html/2402.11753v2 )
- [AI-Würmer]( https://www.heise.de/news/Neue-Wuemerplage-moeglich-Forscher-zeigen-Gefahren-durch-KI-Assistenten-9644593.html )
...
## Themen
 - Ingo am CERN und auf der Kubecon
   * [C3S @ CERN]( https://www.cs3community.org/2024/ )
   * [StorageWeek]( https://techweekstorage.web.cern.ch/ )
   * [Kubecon]( https://events.linuxfoundation.org/kubecon-cloudnativecon-europe/ )

## Mimimi der Woche
- stackoverflow
- [HTML linter / accessibility]( https://github.com/webhintio/hint/pull/5742#issuecomment-1977036895 )
- [Holz (damals war alles besser)]( https://hullworks.com/wood/ )

## Lesefoo
- [NixOS: Everything Everywhere All At Once (video)]( https://www.youtube.com/watch?v=CwfKlX3rA6E )
- [U.S. and International Partners Issue Recommendations to Secure Software Products Through Memory Safety]( https://www.nsa.gov/Press-Room/Press-Releases-Statements/Press-Release-View/Article/3608324/us-and-international-partners-issue-recommendations-to-secure-software-products/ )
- [Test your Apps and Services with Github Actions Quickly and for Free]( https://nixcademy.com/2024/03/01/nixos-integration-test-on-github/ )
  - [Saved by nixos integration tests, surprisingly]( https://boinkor.net/2024/02/saved-by-nixos-integration-tests-surprisingly/ )
- [Incus Gitlab Runner]( https://l33tsource.com/blog/2024/02/17/Incus-GitLab-runner/ )
- [fixing ext4 under pressure]( https://sdomi.pl/weblog/18-fixing-ext4-under-pressure/ )
- [The case against self-closing tags in HTML]( https://jakearchibald.com/2023/against-self-closing-tags-in-html/ )
- [ThinkPad X1 Carbon mit USB-Gadget Mode]( https://xairy.io/articles/thinkpad-xdci )
...
- [Gifcities]( https://gifcities.org/ )
  - ![Dollar]( https://web.archive.org/web/20090901171521if_/http://geocities.com/TimesSquare/Dungeon/2931/whitman/meet/dollar.gif )
