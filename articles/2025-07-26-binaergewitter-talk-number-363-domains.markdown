...
sharing: true
published: true
chapters: https://download.binaergewitter.de/2025-07-25.Binaergewitter.Talk.363.chapters.txt
transcript: https://download.binaergewitter.de/2025-07-25.Binaergewitter.Talk.363-speech.json
audioformats:
  mp3: https://download.binaergewitter.de/2025-07-25.Binaergewitter.Talk.363.mp3
  ogg: https://download.binaergewitter.de/2025-07-25.Binaergewitter.Talk.363.ogg
  opus: https://download.binaergewitter.de/2025-07-25.Binaergewitter.Talk.363.opus
voices:
  l33tname: true
  madmas: false
  ingo: true
...
## Toter der Woche
- [Clear Linux OS]( https://www.linux-magazin.de/news/ploetzliches-aus-intel-stampft-clear-linux-os-ein )
  - [talos]( https://www.talos.dev/ )
- [Porn Games in Steam]( https://www.gamingonlinux.com/2025/07/valve-gets-pressured-by-payment-processors-with-a-new-rule-for-game-devs-and-various-adult-games-removed/ ) 
- [bullseye-backports]( https://backports.debian.org/news/bullseye_backports_discontinued/ )
- [Bitnami Docker Images]( https://github.com/bitnami/charts/issues/35164 )
- [Belink Wemo IoT Zeug]( https://arstechnica.com/gadgets/2025/07/belkin-shows-tech-firms-getting-too-comfortable-with-bricking-customers-stuff/ )

## Untoter der Woche
- [AI Halluzinierte Produkt Features]( https://arstechnica.com/ai/2025/07/chatgpt-made-up-a-product-feature-out-of-thin-air-so-this-company-created-it/ ) 

## AI der Woche
- [KI-Band macht Cash]( https://www.heise.de/news/Wie-die-KI-Band-Velvet-Sundown-die-Musikbranche-aufmischt-10493786.html )
...
- [Repl.it lässt seine Produktionsdatenbank von AI wipen]( https://old.reddit.com/r/OpenAI/comments/1m4lqvh/replit_ai_went_rogue_deleted_a_companys_entire/ )
- [Carlsen-Verlag zu Umgang mit Conni Memes]( https://www.heise.de/news/Umgang-mit-Conni-Memes-im-Internet-Zweite-Klarstellung-des-Carlsen-Verlags-10485774.html )
...
- [WiX Toolset asks for Open Source Maintenance Fee]( https://github.com/wixtoolset/issues/issues/8974 )

## Themen

* Rust
  - [gRPC]( https://groups.google.com/g/grpc-io/c/ExbWWLaGHjI?pli=1 )
  - [tonic]( https://github.com/hyperium/tonic )
  - [tonic-flatbuffers]( https://github.com/ncrothers/tonic-flatbuffers )
  - [inwx]( https://gitlab.com/faulesocke/inwx-rs )
  - [Updated in the last x years]( https://mastodon.social/@l33tname/114884821756654840 )

## Mimimi der Woche

- Amazon Prime auf dem FireTV gebuttdialed
- [terraform]()
  - [What makes NixOS different]( https://dashdot.me/what-makes-nixos-different/ )
